...
Dongdong Wang and Jia Gou.  
*Accumulation of the attenuation operator \(t^*\) along wavefront evolution in heterogeneous absorbing media using a modified fast marching method.*  
